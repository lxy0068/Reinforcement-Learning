    ...
    for episode in tqdm.trange(episodes):
        ...
        while True:
            ...
            if len(replay_buffer) > BATCH_SIZE:
                ...
                critic_loss = F.mse_loss(Q_values.cpu(), y.detach())
...
def main():
    ...
    critic_modes = ['Linear','Linear2','Residue1','Residue2']
    ...
    for actor_mode in actor_modes:
        for critic_mode in critic_modes:
            ...
            actor = Actor(mode=actor_mode)
            critic = Critic(mode=critic_mode)
            target_actor = Actor(mode=actor_mode)
            target_critic = Critic(mode=critic_mode)
